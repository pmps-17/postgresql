...
typedef struct BufferDesc
{
	...
	int			freeNext;	
	int			lruNext;	/* link in freelist chain */
...
extern void LRUInitialize(bool init);
extern bool have_free_buffer(void);

/*----------------- project 3 changes ------------------------------*/
/* lrulist.c */
extern void AddToLruList(BufferDesc *buf, uint32 buf_state);
extern void RemoveFromLruList(BufferDesc *buf, uint32 buf_state);
